    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (currentUser == null) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Error: No s\'han trobat dades de l\'usuari')),
        );
        return;
      }
            ...
            TextButton(
              onPressed: () async {
                ...
                if (oldPasswordController.text != currentUser.password) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('La contrasenya antiga no és correcta')),
                  );
                  return;
                }
                ...
                final updatedUser = User(
                  ...
                  age: currentUser.age,
                  password: newPasswordController.text, // Actualiza la contraseña
                );
                ...
                if (success) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Error al actualitzar la contrasenya')),
                  );
                }
              },
