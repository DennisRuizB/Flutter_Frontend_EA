...
class AuthService {
  ...
  User? get currentUser => _currentUser; // Getter para acceder al usuario autenticado
  ...
  Future<User?> login(String email, String password) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _currentUser = User.fromJson(responseData); // Crea una instancia de User
    ...
    Future<bool> updateUser(User updatedUser) async {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData['acknowledged'] == true && responseData['modifiedCount'] > 0) {
            _currentUser = updatedUser; // Actualiza manualmente currentUser con updatedUser
